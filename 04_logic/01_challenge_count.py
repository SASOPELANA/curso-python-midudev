...
En el universo de los 4 Fantásticos, la unión y el equilibrio entre los
poderes es fundamental para enfrentar cualquier desafío.
...
cuántas veces aparece la letra R (para Reed Richards) y cuántas veces aparece la
...
def check_is_balanced(text):
    ...
    # Simplificar if en python
    return count_r == count_j


print(check_is_balanced("RRJJ"))
print(check_is_balanced("RRRrrrJJJJ"))
print(check_is_balanced("AIAIAIAIAaiaia"))
print(check_is_balanced("1245asf3sa6as4df5RRJJ8"))
