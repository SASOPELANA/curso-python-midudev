...
Imagina que tienes una lista de números enteros en la que cada número representa la
cantidad de huevos puestos por un dinosaurio en el parque.
...
def contar_huevos_dinosaurios_carnivoros(huevos_list) -> int:
    ...
    total_huevos_carnivoros = 0

    for huevos in huevos_list:
        if huevos % 2 == 0:
            total_huevos_carnivoros += huevos

    return total_huevos_carnivoros


huevos_list = [2, 3, 4, 5, 15, 23, 1, 3]

print(contar_huevos_dinosaurios_carnivoros(huevos_list))  # --> 6
